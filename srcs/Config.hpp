...
class Config
{
  ...
  private:
    ...
    bool    get_server_line(std::string s, std::string::size_type *i, std::string::size_type *line_i, Server *serv_tmp, size_t calling_lvl, size_t *i_loc, std::vector<std::pair<std::string, std::string> >*vp, bool* a, std::map<std::string,Server> *ptrmap);
